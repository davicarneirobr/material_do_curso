...
library(remotes)
install_github("curso-r/CursoRTarefas")
...
glimpse(base.de.dados.fevereiro)
...
base_de_dados$origem #RETORNA COMO UM VETOR

base_de_dados$companhia_aerea #RETORNA COMO UM VETOR
...
amostra.avioes.segunda.versao <- data.frame(
  
  codigo.cauda=c("N10156", "N102UW", "N103US"),
  ano=c(2004,1998,1999),
  motores=c(2,2,2),
  assentos=c(55,182,182)
)
