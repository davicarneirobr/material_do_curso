...
#remover values (apagar objeto)
#rm(nome_do_objeto) exemplo
rm(a)
...
#a funcao "c" concatena os elementos
...
#adicionar novo elemento no vetor

vetor <- c("e", vetor)

# Você também pode excluir elementos de um vetor baseado na posicao
...
vetor <- c(1, 2, "a")
vetor.com.true <- c(1,2,3,TRUE)
vetor.com.false <- c(1,2,2,FALSE)
...
#para substituir um dos elementos do vetor
...
objeto.vetor[1]
objeto.vetor[2]
versao.negativa <- objeto.vetor * -1

#para saber o valor do último elemento (para dar reprodutibilidade, 
#se eu adicionar mais elementos no vertor no futuro)

objeto.vetor[length(objeto.vetor)]
...
#por padrao, ele vai fazer, em seq, sempre, from, to, by

seq(2, 10, 4)


vetor_exemplos <- c(1, 5, 3.5, 7.23, 2.1, 3.8)
...
#para arrendodar para valores com dois digitos
round(vetor_exemplos, digits = 2)
...
paste0("a", "b", vetor) # cola os elementos sem separar - sem espaco!
paste0("b", "a")
